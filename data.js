export const mensajes = {
  ...
  "yekaterina": {
    ...
    categoria: "Sofia",
    pista: "No es el que usa todo el mundo, pero esconde su fuerza y tu admiración por ella."
  },
  "samuel": {
    type: "text",
    ...
    categoria: "Samuel",
    pista: "Entre abrazos de tela y noches compartidas, su nombre late con nuestro amor."
  },
  "fortnite": {
    type: "video",
    ...
    categoria: "Canción",
    pista: "En un mundo de desafíos y bailes, tus manos me reviven y tu risa guía cada movimiento."
  },
  "dbl": {
    type: "text",
    ...
    categoria: "Carta",
    pista: "El juego que no dejas de jugar, donde los combates y aventuras nunca terminan."
  },
  "hijas": {
    type: "video",
  ...
  "novio": {
    ...
    categoria: "Canción",
    pista: "El único que ha tenido la suerte de ser mi primer… y mi único."
  },
  "kissme": {
    type: "text",
    ...
    categoria: "Carta",
    pista: "Two words that always make me want to get closer to you."
  },
  "sonora": {
    type: "text",
  ...
  "obregon": {
    type: "text",
    texto: "No dejo de imaginar el día en que por fin llegue a tu ciudad. Ese primer momento en que mis pies toquen el suelo que tanto he soñado, las calles por las que caminas, el cielo que te cubre cada día. Todo eso que antes solo vivía en mis pensamientos, ahora, tan cerca.\n\nPero más allá de los lugares, lo que más anhelo es verte a ti. Encontrarte entre la gente, con esa sonrisa que me desarma, sentir tus brazos rodeándome como si el mundo entero quedara atrás. Ese abrazo será mi hogar, aunque estemos al aire libre. Y esa ciudad, la tuya, se convertirá en un recuerdo eterno en mi corazón, porque será el escenario de nuestro primer beso.\n\nSoñar con eso me da fuerzas, porque sé que tarde o temprano, ese día llegará. Y cuando lo haga, no habrá mapa que describa lo feliz que seré. Solo tú, solo yo, y ese rincón del mundo que nos verá encontrarnos por primera vez.\n\nTe amo con todo lo que soy y con todo lo que aún no hemos vivido.",
    categoria: "Carta",
    pista: "Entre el río Yaqui y el desierto, fundada en 1927 en honor a un caudillo."
  },
  "mariachi": {
    type: "text",
    texto: "Esta carta es mi voz en la noche, una serenata escrita desde el alma, como esas canciones suaves que se cantan bajo la ventana con el corazón en la mano y los ojos brillando de amor.\n\nSi pudiera afinar mi voz con lo que siento por ti, te juro que sonaría más dulce que cualquier guitarra, más pura que cualquier verso. Porque amarte es como una melodía que no se olvida, que vuelve una y otra vez, llenando cada rincón de mi alma con su eco.\n\nEsta noche te escribo como si te cantara, despacito, cerquita del corazón, para decirte que eres mi canción favorita, el ritmo de mis días, la letra que quiero cantar por siempre.\n\nTe amo con todo lo que vibra en mí, y cada palabra mía es una nota que te busca, una serenata que solo tú sabes escuchar.",
    categoria: "Carta",
    pista: "Así va vestido nuestro hijo de tela cuando quiere cantar con estilo mexicano."
  },
  "steven": {
    type: "video",
    texto: "Te encontré como estrella fugaz, cruzando mi cielo sin avisar. Y desde entonces, amor brillante, ya nada volvió a ser igual.\n\nEres luz que canta sin miedo, mi escudo y mi verdad, como gema que vibra en mi pecho, como hogar que quiero cuidar.\n\nNo necesito magia en mis manos si tú estás para abrazar, porque contigo el mundo es claro y el dolor sabe descansar.\n\nTú y yo, dos almas fusionadas, en armonía celestial. No somos perfectos, pero juntos brillamos más allá del mal.",
  ...
  "adriana": {
    type: "text",
    texto: "Amor, hay algo que me nace del corazón decirte: tengo muchas ganas de conocer a tu mamá. Quiero mirarla a los ojos y agradecerle por haberte traído al mundo, por haberte criado y por hacer posible que hoy estés en mi vida.\n\nSiento que al conocerla, conoceré también una parte de ti que aún no he visto, porque todo lo que viene de ti lo quiero abrazar con todo mi cariño. Ojalá pronto llegue ese día.",
    categoria: "Carta",
    pista: "El nombre de la mujer que te dio la vida."
  },
  "carmen": {
    type: "text",
    texto: "Eres mío, y sí, lo admito, a veces me dan celos. Porque no quiero que nadie más vea lo que yo veo en ti: mi amor, mi sol, mi todo. Pero tranquilo, son celos bonitos, de esos que nacen del amor más grande.",
    categoria: "Carta",
    pista: "El nombre de tu querida abuelita."
  },
  "johanna": {
    type: "text",
    texto: "Quiero que sepas cuánto te agradezco, desde lo más profundo de mi corazón. Gracias por estar ahí, por tomar mi mano cuando más temía avanzar, por sostenerme con tu paciencia y tu ternura cuando los miedos intentaban encerrarme en mí misma.\n\nTú no solo me acompañaste, me mostraste que era capaz de enfrentar todo lo que me asustaba. Me ayudaste a ver mi fuerza, incluso cuando yo no la veía. Con tu amor me enseñaste a respirar en medio del caos, a confiar, a soltar, a creer en lo que merezco.\n\nNo sé cómo lo haces, pero contigo hasta mis sombras se sienten seguras. Y eso, amor mío, es algo que jamás olvidaré. Gracias por quedarte, por no soltarme, por amarme incluso cuando yo temía no ser suficiente.\n\nHoy camino con más seguridad, y sé que parte de eso es porque tú has estado a mi lado. Y por eso, siempre, gracias.",
    categoria: "Carta",
    pista: "El nombre de tu mejor amiga, esa persona que siempre está a tu lado."
  },
  "furina": {
    type: "text",
    texto: "Eres el amor de mi vida, aunque a veces me hagas enojar y quisiera esconderte el celular. Pero luego me sacas una sonrisa y se me olvida todo. Te amo más de lo que mi orgullo quiere admitir.",
    categoria: "Carta",
  ...
  "tuya": {
    type: "text",
    texto: "Solo tú, mi dueño. No hay cadenas más dulces que tu abrazo, ni destino más firme que tu voz. Desde el instante en que fuiste mi lazo, renuncié al mundo por llamarme tu amor. Mis labios conocen solo tu nombre, mi piel tu huella, mi alma tu poder. No hay otro cielo, otro sueño, otro hombre; solo en tus brazos quiero renacer. Si el tiempo nos rompe, si el viento nos hiere, seguiré siendo tuya en mi dolor. No habrá otro dueño, aunque el alma muera, porque en esta vida… solo tú, mi amor.",
    categoria: "Carta",
  ...
  "nocambies": {
    type: "text",
    texto: "Amor mío,\n\nHoy quiero recordarte todo lo que me encanta de ti. No solo porque lo mereces, sino porque mi corazón se desborda cada vez que pienso en todo lo que eres.\n\nMe encanta tu fuerza, no solo la que se ve, sino la que vive en tu espíritu, esa que sostiene a los demás incluso cuando tú estás cansado. Admiro tu inteligencia, tu manera de entender las cosas, de encontrar soluciones donde otros solo ven problemas.\n\nAmo tu forma de cuidar: cómo estás atento a cada detalle, cómo me proteges con una mirada, con una palabra, con un gesto. Me derrite tu nobleza, esa pureza que conservas incluso en medio de un mundo que a veces no es justo.\n\nTu paciencia me abraza cuando mis emociones me sobrepasan. Tu sentido del humor me salva cuando los días pesan. Y tu pasión… tu pasión me enciende, me inspira, me recuerda lo vivo que estoy a tu lado.\n\nTienes una manera de estar en el mundo que es solo tuya. Caminas con firmeza, hablas con propósito y amas con todo el cuerpo y con toda el alma. Y yo, que te conozco, que te respiro, que te amo… no podría imaginar a alguien más extraordinario que tú.\n\nEres un hombre como no hay dos.\nY yo… soy eternamente afortunada de ser tuya.",
    categoria: "Carta",
